...
export class InventoryReportComponent implements OnInit {
  ...
  getObjects() {
    ...
    this.reportsService.getInventoryReports(params, this.userType, this.isDownload, sdate, edate).subscribe((response) => {
    ...
    this.dataService.currentUser.subscribe((data) => {
      if (data) {
        ...
        if(this.userType == 'Distributor' || this.userType == 'Reseller') {
          this.filterColumns = ['Name', 'Email', 'Country', 'Total Allocated Licenses', 'Total Activated Licenses', 'Total Available Licenses', 'User Status', 'User Created Date']
        } else {
          this.filterColumns = ['Name', 'Email', 'Total Allocated Licenses', 'Total Activated Licenses', 'Total Available Licenses', 'User Status', 'User Created Date']
        }
        this.getObjects();
      }
    })
